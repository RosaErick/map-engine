...
**Português** · [English](../../README.md) · [Español](es.md)
...
**[`docs/install/`](../install)** — em
[português](../install/pt.md), [inglês](../install/en.md) e
[espanhol](../install/es.md). Em resumo, dois caminhos:
...
| `text` | escrito no app | fundo preto, glifos coloridos: só as letras acendem |
...
| Documento | O que é |
|---|---|
| [`docs/ARCHITECTURE.md`](../ARCHITECTURE.md) | O que cada arquivo faz, o traço de um frame, as cinco armadilhas de renderização |
| [`AGENTS.md`](../../AGENTS.md) | As decisões de arquitetura em formato ADR, e as regras para quem for mexer |
| [`docs/CHANGELOG.md`](../CHANGELOG.md) | O que mudou a cada versão, e por quê |
| [`docs/FUTURO.md`](../FUTURO.md) | Ideias além da v1, registradas sem compromisso de fazer |
| [`docs/install/`](../install) | Instalação passo a passo, em três idiomas |
