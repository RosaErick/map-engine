    ...
    blocks: [
      { kind: 'p', text: 'Uma superfície é um quadrilátero de quatro cantos. São eles que carregam a perspectiva: arraste até a borda projetada assentar na borda real, e o conteúdo se deforma junto.' },
      {
        ...
        items: [
          ...
          '<b>Shift + clique</b> escolhe mais de uma, e arrastar no vazio faz um laço em volta de várias. Com várias escolhidas, arrastar move todas — e <b>ligar</b> deixa elas assim para sempre, inclusive depois de fechar e reabrir o projeto.',
          'Numa seleção com uma superfície travada, as destravadas andam e a travada fica. Travar fala sobre ela, nunca sobre o grupo.',
        ],
      },
    ...
    blocks: [
      {
        ...
        rows: [
          ...
          ['Shift + clique', 'Acrescenta ou tira da seleção'],
          ['Ctrl+A', 'Escolhe todas as superfícies visíveis'],
        ],
      },
